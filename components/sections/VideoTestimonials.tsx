  ...
  return (
    <section className="py-20 px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gold mb-4 text-center">Víctimas Reales</h2>
        <p className="text-center text-white/60 mb-12 text-lg">
          Desarrolladores que leyeron el libro y vivieron para contarlo
        </p>
